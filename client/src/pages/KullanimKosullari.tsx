        ...
        <Container maxWidth="lg">
          ...
          <Alert severity="info" sx={{ mb: 4, borderRadius: 2 }}>
            <Typography variant="body1">
              <strong>Son Güncelleme:</strong> 1 Ocak 2024 tarihinde güncellenen bu koşullar,
              platformumuzun kullanımını düzenlemektedir.
            </Typography>
          </Alert>
          ...
          <Paper sx={{ p: 4, mb: 6, borderRadius: 3, border: '2px solid #f44336' }}>
            ...
            <Typography variant="body1" sx={{ mb: 3, color: 'text.secondary' }}>
              Aşağıdaki aktiviteler kesinlikle yasaktır ve hesap kapatılmasına neden olabilir:
            </Typography>
            <List>
          ...
          <Paper sx={{ p: 4, mb: 6, borderRadius: 3 }}>
            ...
            <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.7 }}>
              TrucksBus, kullanıcılar arasındaki alım satım işlemlerinde bir aracı platform olarak hizmet vermektedir. 
              Platformumuz üzerinden gerçekleştirilen işlemlerden doğan herhangi bir zarar veya kayıptan 
              sorumlu tutulamaz.
            </Typography>
            <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.7 }}>
              Kullanıcılar, platformu kullanırken kendi sorumluluklarında hareket ederler ve 
              üçüncü taraflarla yapacakları anlaşmalardan TrucksBus sorumlu değildir.
            </Typography>
            <Divider sx={{ my: 3 }} />
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              📧 <strong>E-posta:</strong> info@trucksbus.com<br />
          ...
          <Alert severity="warning" sx={{ borderRadius: 2 }}>
            <Typography variant="body1" sx={{ fontWeight: 500 }}>
              <strong>Önemli:</strong> Bu platformu kullanmaya devam ederek yukarıdaki 
              kullanım koşullarını okuduğunuzu, anladığınızı ve kabul ettiğinizi beyan etmiş olursunuz.
            </Typography>
          </Alert>
        </Container>
      </Box>
