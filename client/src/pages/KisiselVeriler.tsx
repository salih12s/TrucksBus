        ...
        <Container maxWidth="lg">
          ...
          <Alert severity="info" sx={{ mb: 6, borderRadius: 2 }}>
            <Typography variant="body1" sx={{ fontWeight: 500 }}>
              ...
              kapsamında, kişisel verilerinizin güvenliği bizim için
              önceliklidir. Bu sayfada verilerinizin nasıl toplandığı, işlendiği
              ve korunduğu hakkında detaylı bilgi bulabilirsiniz.
            </Typography>
          </Alert>
          ...
          <Paper sx={{ p: 4, borderRadius: 3, border: "2px solid #1976d2" }}>
            ...
            <Alert severity="info" sx={{ borderRadius: 2 }}>
              <Typography variant="body2">
                ...
                değerlendirilip sonuçlandırılacaktır. Kimlik doğrulama
                sürecinden geçtikten sonra işlemleriniz gerçekleştirilecektir.
              </Typography>
            </Alert>
          </Paper>
        </Container>
