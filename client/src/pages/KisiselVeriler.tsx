...
const KisiselVeriler: React.FC = () => {
  const dataTypes = [
    ...
    },
    {
      ...
      items: ['İlan Geçmişi', 'Arama Kayıtları', 'Favori İlanlar', 'Mesajlaşma Geçmişi'],
    },
    {
      category: 'Teknik Bilgiler',
      icon: <Shield sx={{ color: '#9c27b0' }} />,
      items: ['IP Adresi', 'Tarayıcı Bilgileri', 'Cihaz Bilgileri', 'Çerez Verileri'],
    },
  ];
  ...
  const userRights = [
    {
      ...
      description: 'Hangi kişisel verilerinizin işlendiğini öğrenme hakkınız bulunur.',
      icon: <Info sx={{ color: '#2196f3' }} />,
    },
    {
      title: 'Erişim Hakkı',
      description: 'İşlenen kişisel verilerinize erişim talep etme hakkınız bulunur.',
      icon: <Visibility sx={{ color: '#4caf50' }} />,
    },
    {
      title: 'Düzeltme Hakkı',
      description: 'Yanlış veya eksik kişisel verilerinizin düzeltilmesini talep edebilirsiniz.',
      icon: <Edit sx={{ color: '#ff9800' }} />,
    },
    {
      title: 'Silme Hakkı',
      description: 'Kişisel verilerinizin silinmesini talep etme hakkınız bulunur.',
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography variant="h5" sx={{ opacity: 0.9, maxWidth: 700, mx: 'auto' }}>
              KVKK kapsamında kişisel verilerinizin korunması ve işlenmesi hakkında bilgiler
            </Typography>
          </Paper>
          ...
          <Alert severity="info" sx={{ mb: 6, borderRadius: 2 }}>
            <Typography variant="body1" sx={{ fontWeight: 500 }}>
              <strong>6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK)</strong> kapsamında,
              kişisel verilerinizin güvenliği bizim için önceliklidir. Bu sayfada verilerinizin
              nasıl toplandığı, işlendiği ve korunduğu hakkında detaylı bilgi bulabilirsiniz.
            </Typography>
          </Alert>
          ...
          <Paper sx={{ p: 4, borderRadius: 3, border: '2px solid #1976d2' }}>
            ...
            <Alert severity="info" sx={{ borderRadius: 2 }}>
              <Typography variant="body2">
                <strong>Başvuru Süreci:</strong> Talebiniz 30 gün içinde değerlendirilip 
                sonuçlandırılacaktır. Kimlik doğrulama sürecinden geçtikten sonra 
                işlemleriniz gerçekleştirilecektir.
              </Typography>
            </Alert>
          </Paper>
        </Container>
