  ...
  const cookieTypes = [
    {
      ...
      description: 'Sitenin düzgün çalışması için gerekli çerezler. Devre dışı bırakılamaz.',
      examples: ['Oturum bilgileri', 'Güvenlik ayarları', 'Dil tercihleri', 'Çerez onayları'],
      required: true,
    },
    {
      ...
      examples: ['Google Analytics', 'Sayfa görüntülenme sayıları', 'Kullanıcı davranış analizi'],
      required: false,
    },
    {
        ...
        <Container maxWidth="lg">
          ...
          <Alert severity="info" sx={{ mb: 6, borderRadius: 2 }}>
            <Typography variant="body1" sx={{ fontWeight: 500 }}>
              <strong>Çerezler Nedir?</strong> Çerezler, web sitesini ziyaret ettiğinizde 
              tarayıcınızda saklanan küçük metin dosyalarıdır. Site deneyiminizi 
              kişiselleştirmek ve geliştirmek için kullanılır.
            </Typography>
          </Alert>
                ...
                {cookieDetails.map((cookie, index) => (
                  <Box
                    ...
                    sx={{
                      ...
                      minWidth: 700,
                      py: 1,
                      borderBottom: index < cookieDetails.length - 1 ? '1px solid #eee' : 'none',
                    }}
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{
                        color: cookie.type === 'Zorunlu' ? '#f44336' : 
                               cookie.type === 'Analitik' ? '#2196f3' : '#ff9800',
                        fontWeight: 500,
                      }}
                    >
                      {cookie.type}
          ...
          <Alert severity="warning" sx={{ mb: 4, borderRadius: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant="body2">
                  Çerezleri tarayıcı ayarlarınızdan da yönetebilirsiniz. Ancak bazı çerezleri 
                  devre dışı bırakmak sitenin düzgün çalışmamasına neden olabilir.
                </Typography>
              </Box>
            </Box>
          </Alert>
          ...
          <Paper sx={{ p: 4, borderRadius: 3, bgcolor: '#e3f2fd' }}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              Çerez kullanımımız hakkında sorularınız için bizimle iletişime geçebilirsiniz:
            </Typography>
            <Typography variant="body2">
              📧 <strong>E-posta:</strong> cerez@trucksbus.com<br />
