...
const Sustainability: React.FC = () => {
  const sustainabilityGoals = [
    ...
    },
    {
      ...
      description: 'Toplumsal fayda odaklı projeler geliştirerek değer yaratıyoruz.',
    },
    {
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography variant="h5" sx={{ opacity: 0.9, maxWidth: 600, mx: 'auto' }}>
              Gelecek nesillere daha iyi bir dünya bırakmak için sorumluluklarımızı yerine getiriyoruz
            </Typography>
          </Paper>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(3, 1fr)' }, gap: 3, mb: 6 }}>
            {sustainabilityGoals.map((goal, index) => (
              <Card key={index} sx={{ height: '100%', '&:hover': { transform: 'translateY(-4px)', transition: 'all 0.3s' } }}>
