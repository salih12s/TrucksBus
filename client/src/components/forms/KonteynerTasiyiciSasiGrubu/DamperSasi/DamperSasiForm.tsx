...
const DamperSasiForm: React.FC = () => {
  ...
  const handleConfirmedSubmit = async () => {
    ...
    try {
      ...
      submitData.append("damperCapacity", formData.damperCapacity);
        ...
        return (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <TextField
              ...
              multiline
              rows={4}
              placeholder="Damper şasiniz hakkında detaylı bilgi verin"
            />
            ...
            <TextField
              fullWidth
              label="Damper Kapasitesi (m³)"
              name="damperCapacity"
              value={formData.damperCapacity}
              onChange={handleInputChange}
              placeholder="Örn: 15"
            />
            ...
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="Tam Hidrolik">Tam Hidrolik</MenuItem>
                <MenuItem value="Yarı Hidrolik">Yarı Hidrolik</MenuItem>
                <MenuItem value="Manuel">Manuel</MenuItem>
                <MenuItem value="Pnömatik">Pnömatik</MenuItem>
              </Select>
            </FormControl>
