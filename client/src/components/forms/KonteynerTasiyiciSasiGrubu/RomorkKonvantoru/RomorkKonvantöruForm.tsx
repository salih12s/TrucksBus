...
// Römork Konvantörü (Dolli) Markaları (MainLayout'tan alındı)
const ROMORK_KONVANTORU_BRANDS = [
  "Seçiniz",
  "Abd Treyler",
  "Adakon Treyler",
  "Adem Usta Proohauss",
...
const RomorkKonvantöruForm: React.FC = () => {
  ...
  const handleConfirmedSubmit = async () => {
    ...
    try {
      ...
      submitData.append("conveyorLength", formData.conveyorLength);
      submitData.append("conveyorType", formData.conveyorType);
      ...
      submitData.append("subType", "RomorkKonvantoru");
        ...
        return (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <TextField
              ...
              multiline
              rows={4}
              placeholder="Römork konvantörünüz hakkında detaylı bilgi verin"
            />
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Dorse Markası"
              >
                {ROMORK_KONVANTORU_BRANDS.map((brand) => (
            ...
            <TextField
              fullWidth
              label="Konvantör Uzunluğu (metre)"
              name="conveyorLength"
            ...
            <FormControl fullWidth>
              <InputLabel>Konvantör Tipi</InputLabel>
              <Select
                name="conveyorType"
                value={formData.conveyorType}
                onChange={handleSelectChange}
                label="Konvantör Tipi"
              >
                <MenuItem value="Bandlı">Bandlı Konvantör</MenuItem>
                <MenuItem value="Zincirli">Zincirli Konvantör</MenuItem>
                <MenuItem value="Redler">Redler Konvantör</MenuItem>
                <MenuItem value="Vidalı">Vidalı Konvantör</MenuItem>
              </Select>
            </FormControl>
