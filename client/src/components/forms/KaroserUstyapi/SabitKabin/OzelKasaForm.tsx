...
const CASE_TYPE_OPTIONS = [
  ...
  "İnşaat Aracı",
  "Tarım Aracı",
  "Veteriner Hekim Aracı",
  "Mobil Sağlık Aracı",
  "Asansör Servis Aracı",
  "Klima Servis Aracı",
  "Elektrik Servis Aracı",
  "Su İşleri Aracı",
  "Kanalizasyon Aracı",
  "Diğer",
];
...
const OzelKasaForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        "Özel Kasa Karoser ilanı başarıyla oluşturuldu:",
        response.data
      );
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Box sx={{ display: "grid", gap: 3, mb: 4 }}>
              <TextField
                ...
                placeholder="Örn: Tertemiz 2020 Model Özel Kasa Sabit Kabin Karoser"
                required
              />
        ...
        <Dialog open={submitSuccess} onClose={handleSuccessClose}>
          ...
          <DialogContent>
            <Typography variant="body1" sx={{ textAlign: "center" }}>
              Özel Kasa Sabit Kabin Karoser ilanınız başarıyla oluşturuldu.
