...
const TupDamacanaRomorkForm: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      submitData.append("subType", "TupDamacana");
        ...
        return (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            <TextField
              ...
              placeholder="Tüp damacana römorku"
            />
            ...
            <TextField
              ...
              multiline
              rows={4}
              placeholder="Tüp damacana römorkunuz hakkında detaylı bilgi verin"
            />
        ...
        <Card>
          <CardContent>
            <Typography variant="h4" component="h1" gutterBottom>
              Tüp Damacana Römorku İlanı Ver
            </Typography>
